...
- **El dominio de Netlify no se cambia.** Las passkeys quedan atadas al dominio exacto; si se renombra, las cuentas creadas antes dejan de entrar. Probar siempre en la URL principal, nunca en un deploy preview.
