...
- **El dominio de Vercel (`https://masiapp.vercel.app`) no se cambia.** Las huellas quedan amarradas a la dirección exacta del sitio; si se renombra, todas las cuentas creadas antes dejan de entrar.
